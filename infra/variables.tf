  ...
  default = [
    {
      ...
      image_tag_mutability = "IMMUTABLE" # Alterado para IMMUTABLE conforme recomendação tfsec
    },
    {
...
variable "restrict_public_access" {
  description = "Restringir acesso público ao cluster EKS"
  type        = bool
  default     = true
}

variable "allowed_public_cidrs" {
  description = "Lista de CIDRs permitidos para acesso público ao EKS"
  type        = list(string)
